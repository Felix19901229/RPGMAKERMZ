import { Sprite_Button, Sprite_Gauge, Sprite_Name, Sprite_StateIcon } from "../Spriteset/index.js";
...
export class Window extends PIXI.Container {
    ...
    _innerChildren: (Sprite_Button | Sprite_Gauge | Sprite_Name | Sprite_StateIcon)[]=[];
