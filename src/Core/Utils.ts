...
export class Utils {
     ...
     * @constant
     */
    static readonly RPGMAKER_VERSION = "1.0.0";

    static _audioElement:Nullable<HTMLAudioElement>=null;
    
    static _videoElement:Nullable<HTMLVideoElement>=null;

    static _hasEncryptedImages = false;
    static _hasEncryptedAudio = false;
    ...
    static decryptArrayBuffer(source:ArrayBuffer) {
        ...
        const key = this._encryptionKey.match(/.{2}/g) as RegExpMatchArray;
        for (let i = 0; i < 16; i++) {
