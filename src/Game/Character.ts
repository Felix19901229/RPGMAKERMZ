import { Game_CharacterBase } from "./index.js";
...
export class Game_Character extends Game_CharacterBase {
    ...
    _moveRoute: MapEventPage['moveRoute'];
    _moveRouteIndex: number;
    _originalMoveRoute: MapEventPage['moveRoute'];
    ...
    public setMoveRoute(moveRoute:MapEventPage['moveRoute']) {
        ...
        while (nodeList.length > 0) {
            ...
            for (let j = 0; j < 4; j++) {
                ...
                if (index2 < 0 || g2 < nodeList[index2].g) {
                    let neighbor:{ [key: string]: null | number } = {}
                    if (index2 >= 0) {
