...
export class Game_System {
    ...
    _savefileId: number;
    _bgmOnSave: ReturnType<typeof AudioManager.saveBgm>;
    _bgsOnSave: ReturnType<typeof AudioManager.saveBgs>;
    _windowTone: null;
    _battleBgm: Nullable<SoundTiming['se']>;
    _defeatMe: Nullable<SoundTiming['se']>;
    _victoryMe: Nullable<SoundTiming['se']>;
    _savedBgm: Nullable<SoundTiming['se']>;
    _walkingBgm: Nullable<SoundTiming['se']>;
    constructor() {
        this.initialize();
    }
