...
import { ImageManager } from "./index.js";
declare type Game_BattlerBase=any;
//-----------------------------------------------------------------------------
/**
 * ColorManager
 * 
...
export class ColorManager {
    ...
    static hpColor(actor:Game_BattlerBase) {
        if (!actor) {
    ...
    static damageColor(colorType:number) {
        switch (colorType) {
            case 0: // HP damage
                return "#ffffff";
            case 1: // HP recover
