import { Utils, WebAudio, Graphics } from "../Core/index.js";
//-----------------------------------------------------------------------------
/**
 * AudioManager
 * 
...
export class AudioManager {
    ...
    static _currentBgm:Nullable<SoundTiming['se']> = null;
    static _currentBgs:Nullable<SoundTiming['se']> = null;
    static _bgmBuffer:Nullable<WebAudio> = null;
    static _bgsBuffer:Nullable<WebAudio> = null;
    static _meBuffer:Nullable<WebAudio> = null;
    static _seBuffers = [];
