...
type Scene_Gameover = any;
type Scene_Title = any;
type Scene_Battle = any;
type Scene_Map = any;
type SceneUnion = Scene_Gameover | Scene_Title | Scene_Battle | Scene_Map;
//-----------------------------------------------------------------------------
/**
 * SceneManager
 * 
...
export class SceneManager {
    ...
    static _previousClass: SceneUnion;
    ...
    static isNextScene(sceneClass:SceneUnion) {
        return this._nextScene && this._nextScene.constructor === sceneClass;
    };

    static isPreviousScene(sceneClass:SceneUnion) {
        return this._previousClass === sceneClass;
    };

    static goto(sceneClass:SceneUnion) {
        if (sceneClass) {
    ...
    static push(sceneClass:SceneUnion) {
