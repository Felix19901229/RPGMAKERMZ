...
export class BattleManager {
    ...
    static _mapBgm: SoundTiming['se'];
    static _mapBgs: SoundTiming['se'];
    static _rewards:Rewards;
    static _logWindow:null;
    static _currentActor:null;
    static _actionForcedBattler:null;
    static _actionBattlers: null[];
    static _subject:null;
    static _action:null;
    static _spriteset:null;
    static _targets: null[];
    constructor() {
